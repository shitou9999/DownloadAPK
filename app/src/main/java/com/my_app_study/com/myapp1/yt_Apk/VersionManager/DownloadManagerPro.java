...
/**
* 网上下载，没有使用过
 * DownloadManager是系统开放给第三方应用使用的类，包含两个静态内部类DownloadManager.Query和
 * DownloadManager.Request。DownloadManager.Request用来请求一个下载，DownloadManager.Query用来查询下载信息。
 * 用downloadManager的enqueue接口进行下载，返回唯一的downloadId。
 * 注意这个id，我们会在DownloadManagerPro这个工具增强类中用到。
 * DownloadManagerPro
 * <ul>
